...
<aside class="app-sidebar doc-sidebar">
    ...
    <ul class="side-menu">
        ...
        <li class="slide">
            <a class="side-menu__item slide-show" href="javascript:void(0)"><i class="side-menu__icon"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M20 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h15c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 2v3H5V5h15zm-5 14h-5v-9h5v9zM5 10h3v9H5v-9zm12 9v-9h3v9h-3z"/></svg></i><span class="side-menu__label">Tuition Requests</span><i class="angle fa fa-angle-right"></i></a>
            <ul class="slide-menu">
                <li><a class="slide-item" href="{{ route('admin.tuitions.index') }}">All Tuitions</a></li>
                <li><a class="slide-item" href="{{ route('admin.approved.tuitions') }}">Approved Tuitions</a></li>
                <li><a class="slide-item" href="{{ route('admin.un.approved.tuitions') }}">Un Approved Tuitions</a></li>
            </ul>
        </li>
