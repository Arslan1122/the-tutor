...
@section('content')
    <div class="side-app">
        <div class="page-header">
            <h4 class="page-title">Un Approved Tuitions</h4>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="javascript:void(0)">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Un Approved Tuitions</li>
            </ol>
        </div>
        <!--/Page-Header-->
                                    ...
                                    @foreach($tuitions as $key=>$tuition)
                                        <tr>
                                            ...
                                            <td>@if($tuition->is_approved)
                                                ...
                                                @endif</td>
                                            <td>
                                                <a href="{{ route('admin.tuition.approve', $tuition->id) }}" class="btn btn-primary" title="Approve Tuition">
