            ...
            <div id="myCarousel1" class="owl-carousel owl-carousel-icons2">
                <div class="item">
                    <div class="card mb-0 overflow-hidden">
                        <div class="card-body">
                            <div class="power-ribbon power-ribbon-top-left text-warning"><span class="bg-warning"><img src="{{ asset('frontend/assets/images/png/power.png') }}" class=""></span></div>
                            <img src="{{ asset('frontend/assets/images/media/color/sm/6.jpg') }}" alt="img" class="w-9 h-9 br-7 mb-4">
                            <div class="">
