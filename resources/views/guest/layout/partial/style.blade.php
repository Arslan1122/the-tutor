<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="https://spruko.com/demo/edomi/Edomi/assets/images/brand/favicon.ico" type="image/x-icon"/>
    ...
    <!-- Bootstrap css -->
    <link href="{{asset('frontend/assets/plugins/bootstrap/css/bootstrap.css')}}" rel="stylesheet" />
    ...
    <!--Select2 css -->
    <link href="{{asset('frontend/assets/plugins/select2/select2.css')}}" rel="stylesheet" />
