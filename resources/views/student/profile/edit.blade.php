...
@section('content')
    ...
    <!--Page-Header-->
        ...
        <div class="row ">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('student.profile.store') }}">
                            ...
                            <div class="row mb-2">
                                <div class="col-auto">
                                    <img class="avatar brround avatar-xl" src="@if(isset(\Auth::user()->studentProfile->profile_img)) {{ asset(\Auth::user()->studentProfile->profile_img) }} @else {{ asset('backend/assets/images/users/female/3.jpg') }} @endif" alt="Avatar-img">
                                </div>
                                <div class="col">
                            ...
                            <div class="form-group">
                                <label class="form-label font-weight-bold">Write about something about yourself</label>
            ...
            <div class="col-lg-8">
                <form class="card" method="post" action="{{route('student.profile.update',['id'=>Auth::id()])}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="old_image" value="{{@$profile->profile_img}}">
                    <input type="hidden" name="old_clip" value="{{@$profile->intro_clip}}">

                    <div class="card-header">
                        <h3 class="card-title">What kind of teacher you're looking for ?</h3>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-weight-bold">Standards ( You wanna learn)</label>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="form-label font-weight-bold">Subjects ( You wanna learn)</label>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <label class="form-label font-weight-bold">Your Profile Image</label>
                            ...
                            <div class="col-sm-6 col-md-6">
                                <label class="form-label font-weight-bold">Your Introduction Video ( Max 10 MB)</label>
