            ...
            <div class="col-md-12 col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        <div>
                            <h3 class="card-title">My Active Tuitions</h3>
                        </div>
                    </div>
                    <div class="card-body">
                                ...
                                @if(isset($tuitions) && !empty($tuitions))
                                    @foreach($tuitions as $key=>$tuition)
                                        <tr>
                                            ...
                                            <td>{{ $tuition->pay }}</td>
                                            <td>{{ @$tuition->isAcceptedproposals[0]->teacher->name }}</td>
                                            <td>
                                                <a href="{{ route('student.active.tuitions.detail', $tuition->id) }}" class="btn btn-sm btn-dark">
